    ...
    <Teleport to="body">
        <div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    class="inline-block align-bottom bg-white rounded-xl px-4 pt-5 pb-4 text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full sm:p-8">
                    <!-- Close button -->
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                            ...
                            >
                                <div class="space-y-1 text-center">
                                    <svg
                                        class="mx-auto h-14 w-14 text-gray-400 group-hover:text-primary-500 transition-colors duration-200"
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label
                                            class="relative cursor-pointer rounded-md font-medium text-primary-600 hover:text-primary-700 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500 transition-colors duration-200">
                                ...
                                <div v-for="file in uploadingFiles" :key="file.name" class="relative">
                                    <div class="flex items-center justify-between text-sm bg-gray-50 p-3 rounded-lg">
                                        <div class="w-0 flex-1 flex items-center">
                                            <svg class="flex-shrink-0 h-5 w-5 text-gray-400 mr-3" fill="none"
                                                 viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                      d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                                            </svg>
                                            <span class="flex-1 w-0 truncate font-medium text-gray-900">{{
                                                    file.name
                                                }}</span>
                                        </div>
