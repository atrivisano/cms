  ...
  <div class="min-h-screen bg-gray-100">
    <div class="py-10">
      ...
      <main>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <!-- Grid View -->
          <div v-if="viewMode === 'grid'" class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div v-for="file in filteredFiles" :key="file.id" class="relative group">
              <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-all duration-200 ring-1 ring-gray-100">
                <div 
